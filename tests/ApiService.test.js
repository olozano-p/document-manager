...
global.fetch = global.fetch || ((url, options) => {
...
describe('ApiService Concepts', () => {
    ...
    beforeEach(() => {
        mockApiService = {
            ...
            async retryFetch(url, options, maxRetries = 3, delay = 100) {
                let lastError;
...
describe('WebSocket Service Concepts', () => {
    test('should handle connection lifecycle', () => {
        const mockWebSocketService = {
            ...
            notifyDocumentHandlers(document) {
        ...
        let statusChanges = [];
        let documentCount = 0;
        mockWebSocketService.onStatusChange((status) => {
